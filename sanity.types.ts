...
// Variable: ALL_CATEGORIES_QUERRY
// Query: *[            _type == "category"]  | order(name asc)
export type ALL_CATEGORIES_QUERRYResult = Array<{
  _id: string;
  _type: "category";
  _createdAt: string;
  _updatedAt: string;
...
// Variable: ALL_PRODUCTS_QUERRY
// Query: *[            _type == "product"        ]  | order(name asc)
export type ALL_PRODUCTS_QUERRYResult = Array<{
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
...
// Variable: PRODUCTS_SEARCH_QUERRY
// Query: *[                _type == "product"                && name match $searchParam            ]  | order(name asc)
export type PRODUCTS_SEARCH_QUERRYResult = Array<{
  _id: string;
  _type: "product";
  _createdAt: string;
  _updatedAt: string;
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "\n        *[\n            _type == \"category\"]  | order(name asc)\n        ": ALL_CATEGORIES_QUERRYResult;
    "\n        *[\n            _type == \"product\"\n        ]  | order(name asc)\n        ": ALL_PRODUCTS_QUERRYResult;
    "\n    *[_type == \"product\" && slug.current == $slug][0]\n  ": PRODUCT_BY_SLUG_QUERYResult;
    "\n        *[\n            _type == \"product\"\n            && references(*[_type == \"category\" && slug.current == $categorySlug]._id)\n        ]  | order(name asc)\n        ": PRODUCTS_BY_CATEGORY_QUERRYResult;
    "\n            *[\n                _type == \"product\"\n                && name match $searchParam\n            ]  | order(name asc)\n            ": PRODUCTS_SEARCH_QUERRYResult;
